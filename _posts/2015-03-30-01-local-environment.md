...
Because of shared folders, `~/share/startbootstrap-clean-blog-jekyll` and `~/Documents/coreos-vagrant/startbootstrap-clean-blog-jekyll` on your laptop are the same folder. So you can use your laptop's OS and your preferred plain-text editor to modify your title. If you're having trouble with this, please see the paragraph "A word on what to do if you laptop on the Vagrant CoreOS VM get unsynchronized", below.
